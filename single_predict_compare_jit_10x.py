...
# from predict_method import predict2visual
...
def main():
    ...
    PREDICT_JIT_ROOT = config.output_10X_model_seg_dir
    # VISUAL_JIT_ROOT = f'{OUT_ROOT}/seg_10x_v/{dataset_name}'
    MODEL_JIT_PATH = config.seg_10X_model_weight_path
    ...
    with T['jit']:
        ...
        for image_path in tqdm(all_list):
